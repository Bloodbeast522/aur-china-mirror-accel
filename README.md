...
wget https://github.com/Bloodbeast522/aur-keikaku-dori/releases/download/v1.0.0/aur-keikaku-dori-1.0.0-3-any.pkg.tar.zst

# 第 2 步:安装(aria2 不需要手动装,setup 会自动装)
sudo pacman -U aur-keikaku-dori-1.0.0-3-any.pkg.tar.zst
...
> `wget https://gh-proxy.com/https://github.com/Bloodbeast522/aur-keikaku-dori/releases/download/v1.0.0/aur-keikaku-dori-1.0.0-3-any.pkg.tar.zst`
...
install.sh 做的事和 `aur-keikaku-setup` 完全一样(6 步)。
